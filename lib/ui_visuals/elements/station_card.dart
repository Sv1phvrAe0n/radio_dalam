...
class _StationCardState extends State<StationCard> with AutomaticKeepAliveClientMixin {
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      IconButton(
                        ...
                        Icon(Icons.star_border, color: Color(0xffADADAD), size: 35) : Icon(Icons.star, color: Color(0xffADADAD), size: 35),
                        onPressed: () {
